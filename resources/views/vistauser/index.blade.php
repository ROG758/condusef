    ...
    <div class="card-body">
        ...
        <div class="table-reponsive">
            <table class="table caption-top">
                <caption><i class="fas fa-list"></i>Lista  de Usuarios a Sistemas</caption>
                <div>
                    <a href="{{route('vista.create')}}" class="btn btn-primary ml-auto">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group" role="group" aria-label="Basic example">
                                ...
                                <a href="{{route('vista.edit', $vista->idSistemaPersona)}}" class="btn btn-primary"><i
                                ...
                                <form action="{{route('vista.destroy', $vista->idSistemaPersona)}}"
...
$('#limit').on('change', function() {
    window.location.href = "{{ route('vista.index')}}?limit=" + $(this).val() + '&search=' + $('#search')
        .val()
})

$('#search').on('keyup', function(e) {
    if (e.keyCode == 13) {
        window.location.href = "{{ route('vista.index')}}?limit=" + $('#limit').val() + '&search=' + $(
            this).val()
    }
})
</Script>
