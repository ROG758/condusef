...
<div>
    <div class="col-group">
        ...
        <div>
            <select name="idAccesos" id="idAccesos" class="form-control" required>
    ...
    <div class="card-fooder">
        ...
        <div class="col-gorup">
            ...
            <div>
                <select name="idPersonal[]" id="idPersonal" class="control-form selectpicker" title="Seleccionar usuarios"
                    multiple required>
                    <option value="#">Seleccione</option>
